...
class CaptchaService
{
    ...
    protected function createImage($text)
    {
        ...
        // Colors
        $bgColorRGB = $this->parseColor($this->config['bg_color'] ?? '#ffffff', [255, 255, 255]);
        $textColorRGB = $this->parseColor($this->config['text_color'] ?? '#323232', [50, 50, 50]);
        $lineColorRGB = $this->parseColor($this->config['line_color'] ?? '#c8c8c8', [200, 200, 200]);
